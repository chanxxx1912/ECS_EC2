        ...
        for task_details in tasks:
            ...
            for container in containers:
               ...
               # print(dictionary5)
                ...
                l = []
                l.append(dictionary6)
                print(l)
  ----------------------------------------------------------------------------------------------------------------------------              
  Output:
[{'TaskId/Name ': ' env', 'TaskDefId/Name ': ' envtask1:1', 'ImageName ': ' redis1', 'ImageTag ': ' redis:7.0.5', 'ValueOfClusterTag_Channel ': ' voot'}]
[{'TaskId/Name ': ' env', 'TaskDefId/Name ': ' envtask2:4', 'ImageName ': ' redis2', 'ImageTag ': ' redis:7.0.5-bullseye', 'ValueOfClusterTag_Channel ': ' voot'}]       
[{'TaskId/Name ': ' env', 'TaskDefId/Name ': ' envtask3:1', 'ImageName ': ' deployment', 'ImageTag ': ' nginx:1.23.2', 'ValueOfClusterTag_Channel ': ' voot'}]
[{'TaskId/Name ': ' env', 'TaskDefId/Name ': ' envtask3:1', 'ImageName ': ' nginx', 'ImageTag ': ' nginx:1.23', 'ValueOfClusterTag_Channel ': ' voot'}]
[{'TaskId/Name ': ' prod', 'TaskDefId/Name ': ' prodtask2:2', 'ImageName ': ' testing', 'ImageTag ': ' nginx:1.22-alpine', 'ValueOfClusterTag_Channel ': ' prime'}]      
[{'TaskId/Name ': ' prod', 'TaskDefId/Name ': ' prodtask1:2', 'ImageName ': ' production', 'ImageTag ': ' nginx:latest', 'ValueOfClusterTag_Channel ': ' prime'}]        
[{'TaskId/Name ': ' prod', 'TaskDefId/Name ': ' prodtask3:1', 'ImageName ': ' c2', 'ImageTag ': ' nginx:1.22.1-alpine-perl', 'ValueOfClusterTag_Channel ': ' prime'}]    
[{'TaskId/Name ': ' prod', 'TaskDefId/Name ': ' prodtask3:1', 'ImageName ': ' c1', 'ImageTag ': ' redis:6-bullseye', 'ValueOfClusterTag_Channel ': ' prime'}]
[{'TaskId/Name ': ' dev', 'TaskDefId/Name ': ' devtask3:1', 'ImageName ': ' image2', 'ImageTag ': ' nginx:stable', 'ValueOfClusterTag_Channel ': ' netflix'}]
[{'TaskId/Name ': ' dev', 'TaskDefId/Name ': ' devtask3:1', 'ImageName ': ' image1', 'ImageTag ': ' redis:7-alpine', 'ValueOfClusterTag_Channel ': ' netflix'}]
[{'TaskId/Name ': ' dev', 'TaskDefId/Name ': ' devtask1:1', 'ImageName ': ' devcontainer', 'ImageTag ': ' redis:latest', 'ValueOfClusterTag_Channel ': ' netflix'}]      
[{'TaskId/Name ': ' dev', 'TaskDefId/Name ': ' devtask2:1', 'ImageName ': ' containerc1', 'ImageTag ': ' nginx:perl', 'ValueOfClusterTag_Channel ': ' netflix'}]  
---------------------------------------------------------------------------------------------------------------
Expected Output:
[{'ClusterName':'env', 'TaskId/Name':'env',
           'TaskDef Id/Name':'envtask1:1','ImageName':'redis1',
           'ImageTag':'redis:7.0.5','ValueofClusterTag_Channel':'voot',
           'ValueofClusterTag_Env': 'forest'},{'ClusterName':'env', 'TaskId/Name':'env',
           'TaskDef Id/Name':'envtask1:1','ImageName':'redis1',
           'ImageTag':'redis:7.0.5','ValueofClusterTag_Channel':'voot',
           'ValueofClusterTag_Env': 'forest'},{'ClusterName':'env', 'TaskId/Name':'env',
           'TaskDef Id/Name':'envtask1:1','ImageName':'redis1',
